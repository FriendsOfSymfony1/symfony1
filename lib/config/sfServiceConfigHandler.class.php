 ...
 * @version    SVN: $Id$
 */
class sfServiceConfigHandler extends sfConfigHandler
{
  /**
  ...
  public function execute($configFiles)
  {
    ...
    $loader = new sfServiceContainerLoaderFileYaml($serviceContainerBuilder);
    ...
    $retval = sprintf(
      ...
      "}\n".
      "return \$class;\n\n",
      date('Y/m/d H:i:s'), $class, str_replace('<?php', '', $code));
