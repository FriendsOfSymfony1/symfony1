...
/**
 * sfMailerBase is the base class of the main entry point for the mailer system sfMailer and sfMailerSwiftmailer6.
 *
 ...
 * @version    SVN: $Id$
 */
abstract class sfMailerBase extends Swift_Mailer
{
  const
    REALTIME       = 'realtime',
    SPOOL          = 'spool',
   ...
   */
  public abstract function compose($from = null, $to = null, $subject = null, $body = null);
