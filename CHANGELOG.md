 ...
 * Update TextHelper class and unit tests, add documentation, fix & update email linking & add option for unicode characters in email addresses (#10065) (patch from @frost-nzcr4)
