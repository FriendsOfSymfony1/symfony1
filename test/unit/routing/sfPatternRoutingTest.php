...
$options = ['generate_shortest_url' => false, 'extra_parameters_as_query_string' => false];
...
$t->diag('->connect()');
$r->clearRoutes();
$r->connect('test', new \sfRoute(':module/:action', ['module' => 'default', 'action' => 'index']));
$r->connect('test1', new \sfRoute('', ['module' => 'default', 'action' => 'index']));
...
// simple routes
$r->clearRoutes();
$r->connect('test1', new \sfRoute('/:module/:action', ['module' => 'default', 'action' => 'index1']));
$r->connect('test2', new \sfRoute('/foo/bar', ['module' => 'default', 'action' => 'index2']));
$r->connect('test3', new \sfRoute('/foo/:module/bar/:action', ['module' => 'default', 'action' => 'index3']));
$r->connect('test4', new \sfRoute('/nodefault/:module/:action'));

$params = ['module' => 'default', 'action' => 'index1'];
$url = '/default/index1';
...
$t->diag('route order');
$r->clearRoutes();
$r->connect('test', new \sfRoute('/test/:id', ['module' => 'default1', 'action' => 'index1'], ['id' => '\d+']));
$r->connect('test1', new \sfRoute('/test/:id', ['module' => 'default2', 'action' => 'index2']));
$params = ['module' => 'default1', 'action' => 'index1', 'id' => '12'];
$url = '/test/12';
...
$params = ['module' => 'default2', 'action' => 'index2', 'id' => 'foo'];
$url = '/test/foo';
$t->is($r->parse($url), $params, '->parse() takes the first matching route');
$t->is($r->generate('', $params), $url, '->generate() takes the first matching route');

$r->clearRoutes();
$r->connect('test', new \sfRoute('/:module/:action/test/:id/:test', ['module' => 'default', 'action' => 'index']));
$r->connect('test1', new \sfRoute('/:module/:action/test/:id', ['module' => 'default', 'action' => 'index', 'id' => 'foo']));
$params = ['module' => 'default', 'action' => 'index', 'id' => 'foo'];
...
$t->diag('suffix');
$r->clearRoutes();
$r = new \sfPatternRoutingTest(new \sfEventDispatcher(), null, array_merge($options, ['suffix' => '.html']));
$r->connect('foo0', new \sfRoute('/foo0/:module/:action/:param0', ['module' => 'default', 'action' => 'index0']));
$url0 = '/foo0/default/index0/foo0.html';
$r->connect('foo1', new \sfRoute('/foo1/:module/:action/:param1.', ['module' => 'default', 'action' => 'index1']));
$url1 = '/foo1/default/index1/foo1';
$r->connect('foo2', new \sfRoute('/foo2/:module/:action/:param2/', ['module' => 'default', 'action' => 'index2']));
$url2 = '/foo2/default/index2/foo2/';
$r->connect('foo3', new \sfRoute('/foo3/:module/:action/:param3.foo', ['module' => 'default', 'action' => 'index3']));
$url3 = '/foo3/default/index3/foo3.foo';
$r->connect('foo4', new \sfRoute('/foo4/:module/:action/:param4.:param_5', ['module' => 'default', 'action' => 'index4']));
$url4 = '/foo4/default/index4/foo.bar';

$t->is($r->generate('', ['module' => 'default', 'action' => 'index0', 'param0' => 'foo0']), $url0, '->generate() creates URL suffixed by "sf_suffix" parameter');
$t->is($r->generate('', ['module' => 'default', 'action' => 'index1', 'param1' => 'foo1']), $url1, '->generate() creates URL with no suffix when route ends with .');
$t->is($r->generate('', ['module' => 'default', 'action' => 'index2', 'param2' => 'foo2']), $url2, '->generate() creates URL with no suffix when route ends with /');
$t->is($r->generate('', ['module' => 'default', 'action' => 'index3', 'param3' => 'foo3']), $url3, '->generate() creates URL with special suffix when route ends with .suffix');
$t->is($r->generate('', ['module' => 'default', 'action' => 'index4', 'param4' => 'foo', 'param_5' => 'bar']), $url4, '->generate() creates URL with no special suffix when route ends with .:suffix');

$t->is($r->parse($url0), ['module' => 'default', 'action' => 'index0', 'param0' => 'foo0'], '->parse() finds route from URL suffixed by "sf_suffix"');
$t->is($r->parse($url1), ['module' => 'default', 'action' => 'index1', 'param1' => 'foo1'], '->parse() finds route with no suffix when route ends with .');
$t->is($r->parse($url2), ['module' => 'default', 'action' => 'index2', 'param2' => 'foo2'], '->parse() finds route with no suffix when route ends with /');
$t->is($r->parse($url3), ['module' => 'default', 'action' => 'index3', 'param3' => 'foo3'], '->parse() finds route with special suffix when route ends with .suffix');
$t->is($r->parse($url4), ['module' => 'default', 'action' => 'index4', 'param4' => 'foo', 'param_5' => 'bar'], '->parse() finds route with special suffix when route ends with .:suffix');
...
$r->clearRoutes();
$r->connect('test', new \sfRoute('/:module/:action/:foo', ['module' => 'default', 'action' => 'index', 'foo' => 'bar']));
$t->is(
    $r->generate('', ['module' => 'default']),
    '/default/index/bar',
...
$r->clearRoutes();
$r->connect('test', new \sfRoute('/:module/:action', ['module' => 'default']));
$params = ['module' => 'default', 'action' => 'index'];
$url = '/default/index';
...
// combined examples
$r->clearRoutes();
$r->connect('test', new \sfRoute('/:module/:action/:test/:id', ['module' => 'default', 'action' => 'index', 'id' => 'toto']));
$params = ['module' => 'default', 'action' => 'index', 'test' => 'foo', 'id' => 'bar'];
...
$params = ['module' => 'default', 'action' => 'index', 'test' => 'foo', 'id' => 'toto'];
...
$r->clearRoutes();
$r->connect('test', new \sfRoute('/:module/:action/:test/:id', ['module' => 'default', 'action' => 'index', 'test' => 'foo', 'id' => 'bar']));
$params = ['module' => 'default', 'action' => 'index', 'test' => 'foo', 'id' => 'bar'];
$url = '/default/index';
...
$r->clearRoutes();
$r->connect('test', new \sfRoute('/test/:foo/:id', ['module' => 'default', 'action' => 'index']));
$params = ['module' => 'default', 'action' => 'index', 'id' => 12];
$url = '/test/bar/12';
...
$r->clearRoutes();
$r->connect('test', new \sfRoute('/:module/:action/test/*', ['module' => 'default', 'action' => 'index']));
$params = ['module' => 'default', 'action' => 'index'];
...
$params = ['module' => 'default', 'action' => 'index', 'titi' => 'toto'];
...
$params = ['module' => 'default', 'action' => 'index', 'page' => '4.html', 'toto' => true, 'titi' => 'toto', 'OK' => true];
...
$r->clearRoutes();
$r->connect('test', new \sfRoute('/:module', ['action' => 'index']));
$r->connect('test1', new \sfRoute('/:module/:action/*', []));
$params = ['module' => 'default', 'action' => 'index', 'toto' => 'titi'];
...
$params = ['module' => 'default', 'action' => 'index', 'foo' => true, 'bar' => 'foobar'];
...
$t->diag('requirements');
$r->clearRoutes();
$r->connect('test', new \sfRoute('/:module/:action/id/:id', ['module' => 'default', 'action' => 'integer'], ['id' => '\d+']));
$r->connect('test1', new \sfRoute('/:module/:action/:id', ['module' => 'default', 'action' => 'string']));

$params = ['module' => 'default', 'action' => 'integer', 'id' => 12];
...
$params = ['module' => 'default', 'action' => 'string', 'id' => 'NOTANINTEGER'];
...
$r->clearRoutes();
$r->connect('test', new \sfRoute('/:module/:action/id/:id', ['module' => 'default', 'action' => 'integer'], ['id' => '[^/]{2}']));

$params = ['module' => 'default', 'action' => 'integer', 'id' => 'a1'];
...
// separators
$t->diag('separators');
$r = new \sfPatternRoutingTest(new \sfEventDispatcher(), null, array_merge($options, ['segment_separators' => ['/', ';', ':', '|', '.', '-', '+']]));
$r->connect('test', new \sfRoute('/:module/:action;:foo::baz+static+:toto|:hip-:zozo.:format', []));
$r->connect('test0', new \sfRoute('/:module/:action0', []));
$r->connect('test1', new \sfRoute('/:module;:action1', []));
$r->connect('test2', new \sfRoute('/:module::action2', []));
$r->connect('test3', new \sfRoute('/:module+:action3', []));
$r->connect('test4', new \sfRoute('/:module|:action4', []));
$r->connect('test5', new \sfRoute('/:module.:action5', []));
$r->connect('test6', new \sfRoute('/:module-:action6', []));
$params = ['module' => 'default', 'action' => 'index', 'action0' => 'foobar'];
$url = '/default/foobar';
...
$params = ['module' => 'default', 'action' => 'index', 'action1' => 'foobar'];
$url = '/default;foobar';
$t->is($r->parse($url), $params, '->parse() recognizes parameters separated by ;');
$t->is($r->generate('', $params), $url, '->generate() creates routes with ; separator');
$params = ['module' => 'default', 'action' => 'index', 'action2' => 'foobar'];
$url = '/default:foobar';
$t->is($r->parse($url), $params, '->parse() recognizes parameters separated by :');
$t->is($r->generate('', $params), $url, '->generate() creates routes with : separator');
$params = ['module' => 'default', 'action' => 'index', 'action3' => 'foobar'];
$url = '/default+foobar';
$t->is($r->parse($url), $params, '->parse() recognizes parameters separated by +');
$t->is($r->generate('', $params), $url, '->generate() creates routes with + separator');
$params = ['module' => 'default', 'action' => 'index', 'action4' => 'foobar'];
$url = '/default|foobar';
$t->is($r->parse($url), $params, '->parse() recognizes parameters separated by |');
$t->is($r->generate('', $params), $url, '->generate() creates routes with | separator');
$params = ['module' => 'default', 'action' => 'index', 'action5' => 'foobar'];
$url = '/default.foobar';
$t->is($r->parse($url), $params, '->parse() recognizes parameters separated by .');
$t->is($r->generate('', $params), $url, '->generate() creates routes with . separator');
$params = ['module' => 'default', 'action' => 'index', 'action' => 'index', 'action6' => 'foobar'];
$url = '/default-foobar';
$t->is($r->parse($url), $params, '->parse() recognizes parameters separated by -');
$t->is($r->generate('', $params), $url, '->generate() creates routes with - separator');
$params = ['module' => 'default', 'action' => 'index', 'action' => 'foobar', 'foo' => 'bar', 'baz' => 'baz', 'toto' => 'titi', 'hip' => 'hop', 'zozo' => 'zaza', 'format' => 'xml'];
...
// see ticket #8114
$r = new \sfPatternRoutingTest(new \sfEventDispatcher(), null, array_merge($options, ['segment_separators' => []]));
$r->connect('nosegment', new \sfRoute('/:nonsegmented', []));
$params = ['module' => 'default', 'action' => 'index', 'nonsegmented' => 'plainurl'];
$url = '/plainurl';
...
$params = ['module' => 'default', 'action' => 'index', 'nonsegmented' => 'foo/bar/baz'];
...
$r = new \sfPatternRoutingTest(new \sfEventDispatcher(), null, array_merge($options, ['variable_prefixes' => [':', '$']]));

// token names
$t->diag('token names');
$r->clearRoutes();
$r->connect('test1', new \sfRoute('/:foo_1/:bar2', []));
$params = ['module' => 'default', 'action' => 'index', 'foo_1' => 'test', 'bar2' => 'foobar'];
$url = '/test/foobar';
...
$t->diag('token prefix');
$r->clearRoutes();
$r->connect('test2', new \sfRoute('/2/$module/$action/$id', []));
$r->connect('test3', new \sfRoute('/3/$module/:action/$first_name/:last_name', []));
$r->connect('test1', new \sfRoute('/1/:module/:action', []));
$params1 = ['module' => 'foo', 'action' => 'bar'];
$url1 = '/1/foo/bar';
...
$params2 = ['module' => 'foo', 'action' => 'bar', 'id' => 12];
$url2 = '/2/foo/bar/12';
...
$params3 = ['module' => 'foo', 'action' => 'bar', 'first_name' => 'John', 'last_name' => 'Doe'];
...
$t->diag('named routes');
$r->clearRoutes();
$r->connect('test', new \sfRoute('/test/:id', ['module' => 'default', 'action' => 'integer'], ['id' => '\d+']));
$params = ['module' => 'default', 'action' => 'integer', 'id' => 12];
$url = '/test/12';
$named_params = ['id' => 12];
...
$routes = $r->getRoutes();
$r->clearRoutes();
$r->appendRoute('test', new \sfRoute('/:module', ['action' => 'index']));
$r->appendRoute('test1', new \sfRoute('/:module/:action/*', []));
...
$r->clearRoutes();
$r->prependRoute('test', new \sfRoute('/:module', ['action' => 'index']));
$r->prependRoute('test1', new \sfRoute('/:module/:action/*', []));
...
$r->clearRoutes();
$r->connect('test1', new \sfRoute('/:module', ['action' => 'index']));
$r->connect('test3', new \sfRoute('/:module/:action/*', []));
$r->insertRouteBefore('test3', 'test2', new \sfRoute('/:module/:action', ['module' => 'default']));
$route_names = array_keys($r->getRoutes());
$r->clearRoutes();
$r->connect('test1', new \sfRoute('/:module', ['action' => 'index']));
$r->connect('test2', new \sfRoute('/:module/:action', ['module' => 'default']));
$r->connect('test3', new \sfRoute('/:module/:action/*', []));
...
try {
    $r->insertRouteBefore('test2', 'test', new \sfRoute('/index.php/:module/:action', ['module' => 'default', 'action' => 'index']));
    $t->fail($msg);
...
$r->clearRoutes();
$r->connect('test2', new \sfRoute('/module/action/:id', ['module' => 'foo', 'action' => 'bar']));
$r->connect('test', new \sfRoute('/:module', ['action' => 'index']));
$r->connect('test1', new \sfRoute('/:module/:action/*', []));
$r->connect('test3', new \sfRoute('/', []));
$r->parse('/');
...
function configureRouting($event)
{
    ...
    $event->getSubject()->connect('second', new \sfRoute('/', []));
}
...
$rCached->connect('test', new \sfRoute('/:module', ['action' => 'index']));
$rCached->connect('test2', new \sfRoute('/', []));
$rCached->parse('/');
...
$t->is(
    $parameters,
    ['name' => 'test', 'pattern' => '/:module', 'parameters' => ['action' => 'index', 'module' => 'test']],
...
$r->clearRoutes();
$r->connect('test', new \sfRoute('/test', ['bar' => 'foo']));
$r->parse('/test');
$r->parse('/notfound');
...
$params = ['module' => 'default', 'action' => 'index', 'bar' => 'foo'];
$t->is($r->generate('', $params), $url, '->generate() routes takes default values into account when matching a route');
$params = ['module' => 'default', 'action' => 'index', 'bar' => 'bar'];
...
$r->clearRoutes();
$r->connect('test', new \sfRoute('/', ['module' => 'default1', 'action' => 'default1']));
$params = ['module' => 'default1', 'action' => 'default1'];
...
$r->clearRoutes();
$r->connect('test', new \sfRoute('/test/:value', ['module' => 'default', 'action' => 'index']));
$r->connect('test1', new \sfRoute('/test1/*', ['module' => 'default', 'action' => 'index']));
$t->is($r->parse('/test/test%26foo%3Dbar%2Bfoo'), ['module' => 'default', 'action' => 'index', 'value' => 'test&foo=bar+foo'], '->parse() decodes parameter values');
$t->is($r->parse('/test1/value/test%26foo%3Dbar%2Bfoo'), ['module' => 'default', 'action' => 'index', 'value' => 'test&foo=bar+foo'], '->parse() decodes parameter values');

// feature change bug from sf1.0 - ticket #3090
$r->clearRoutes();
$r->connect('test', new \sfRoute('/customer/:param1/:action/*', ['module' => 'default']));
$r->connect('default', new \sfRoute('/:module/:action'));
$url = '/customer/create';
$params = ['module' => 'customer', 'action' => 'create'];
$t->is($r->parse($url), $params, '->parse() /:module/:action route');

$url = '/customer/param1/action';
$params = ['module' => 'default', 'action' => 'action', 'param1' => 'param1'];
$t->is($r->parse($url), $params, '->parse() /customer/:param1/:action/* route');

$r->clearRoutes();
$r->connect('test', new \sfRoute('/customer/:id/:id_name', ['module' => 'default']));
$t->is($r->generate('', ['id' => 2, 'id_name' => 'fabien']), '/customer/2/fabien', '->generate() first replaces the longest variable names');

$r->clearRoutes();
$r->connect('default', new \sfAlwaysAbsoluteRoute('/:module/:action'));
$t->is($r->generate('', ['module' => 'foo', 'action' => 'bar']), 'http://localhost/foo/bar', '->generate() allows route to generate absolute urls');
$t->is($r->generate('', ['module' => 'foo', 'action' => 'bar'], true), 'http://localhost/foo/bar', '->generate() does not double-absolutize urls');

$t->diag('suffix handling with generate_shortest_url option');

$r = new \sfPatternRoutingTest(new \sfEventDispatcher(), null, ['generate_shortest_url' => true, 'extra_parameters_as_query_string' => false, 'suffix' => '.html']);
$r->connect('test2', new \sfRoute('/users/:username/:sort/:start/', ['module' => 'user', 'action' => 'show', 'sort' => 'all', 'start' => '0'], ['requirements' => ['username' => '\w+', 'start' => '\d+']]));
$t->is($r->generate('', ['username' => 'test1', 'module' => 'user', 'action' => 'show']), '/users/test1/', '->generate() creates URL when using suffix and generate_shortest_url');
$t->is($r->generate('', ['username' => 'test1', 'module' => 'user', 'action' => 'show', 'sort' => 'all', 'start' => '1']), '/users/test1/all/1/', '->generate() creates URL when using suffix and generate_shortest_url');
$t->is($r->parse('/users/test1/'), ['module' => 'user', 'action' => 'show', 'sort' => 'all', 'start' => '0', 'username' => 'test1'], '->parse() returns all default parameters when provided suffix and generate_shortest_url enabled with / suffix');

$r = new \sfPatternRoutingTest(new \sfEventDispatcher(), null, ['generate_shortest_url' => true, 'extra_parameters_as_query_string' => false, 'suffix' => '.html']);
$r->connect('test1', new \sfRoute('/users/:username/:sort/:start', ['module' => 'user', 'action' => 'show', 'sort' => 'all', 'start' => '0'], ['requirements' => ['username' => '\w+', 'start' => '\d+']]));
$t->is($r->generate('', ['username' => 'test1', 'module' => 'user', 'action' => 'show']), '/users/test1.html', '->generate() creates URL when using suffix and generate_shortest_url');
$t->is($r->generate('', ['username' => 'test1', 'module' => 'user', 'action' => 'show', 'sort' => 'all', 'start' => '0']), '/users/test1.html', '->generate() creates URL when using suffix and generate_shortest_url');
$t->is($r->generate('', ['username' => 'test1', 'module' => 'user', 'action' => 'show', 'sort' => 'all', 'start' => '1']), '/users/test1/all/1.html', '->generate() creates URL when using suffix and generate_shortest_url');

$t->is($r->parse('/users/test1.html'), ['module' => 'user', 'action' => 'show', 'sort' => 'all', 'start' => '0', 'username' => 'test1'], '->parse() returns all default parameters when provided suffix and generate_shortest_url enabled with .html suffix');

$r = new \sfPatternRoutingTest(new \sfEventDispatcher(), null, ['generate_shortest_url' => true, 'extra_parameters_as_query_string' => false, 'suffix' => '.html']);
$r->connect('posts', new \sfRoute('/posts', ['module' => 'posts', 'action' => 'index', 'page' => '1']));
$r->connect('posts_pages', new \sfRoute('/posts/:page', ['module' => 'posts', 'action' => 'index', 'page' => '1']));

$t->is($r->generate('', ['module' => 'posts', 'action' => 'index']), '/posts.html', '->generate() creates URL when using suffix and generate_shortest_url');
$t->is($r->generate('', ['module' => 'posts', 'action' => 'index', 'page' => '1']), '/posts.html', '->generate() creates URL when using suffix and generate_shortest_url');
$t->is($r->generate('', ['module' => 'posts', 'action' => 'index', 'page' => '2']), '/posts/2.html', '->generate() creates URL when using suffix and generate_shortest_url');

$t->diag('load_configuration with serialized routes');

// see fixtures/config_routing.yml.php
$r = new \sfPatternRoutingTest(new \sfEventDispatcher(), new \sfNoCache(), ['load_configuration' => true]);
...
$t->is_deeply($r->parse('/'), ['module' => 'default', 'action' => 'index'], '->parse() Default parameters are applied to serialized routes');
