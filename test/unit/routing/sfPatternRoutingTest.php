...
mkdir(dirname(__FILE__).'/fixtures');
file_put_contents(dirname(__FILE__).'/fixtures/config_routing.yml.php', sprintf("<?php\n".
  "// auto-generated by sfRoutingConfigHandler\n".
  "// date: %s\n%s\n", date('Y/m/d H:i:s'), sprintf('$this->routes[\'%s\'] = %s;', 'test1', var_export(sfToolkit::serialize(new sfRoute('/')), true))));
...
unlink(dirname(__FILE__).'/fixtures/config_routing.yml.php');
rmdir(dirname(__FILE__).'/fixtures');
