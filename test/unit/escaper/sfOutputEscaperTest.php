...
$t->ok(null === \sfOutputEscaper::escape('esc_entities', null), '::escape() returns null if the value to escape is null');
$t->ok(false === \sfOutputEscaper::escape('esc_entities', false), '::escape() returns false if the value to escape is false');
$t->ok(true === \sfOutputEscaper::escape('esc_entities', true), '::escape() returns true if the value to escape is true');
...
$t->ok(null === \sfOutputEscaper::unescape(null), '::unescape() returns null if the value to unescape is null');
$t->ok(false === \sfOutputEscaper::unescape(false), '::unescape() returns false if the value to unescape is false');
$t->ok(true === \sfOutputEscaper::unescape(true), '::unescape() returns true if the value to unescape is true');
