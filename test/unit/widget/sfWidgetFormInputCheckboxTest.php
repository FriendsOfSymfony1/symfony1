...
$t->is($w->render('foo', 0, ['value' => '0']), '<input type="checkbox" name="foo" value="0" checked="checked" id="foo" />', '->render() renders the widget as HTML');
...
$t->is($w->render('foo', null, ['value' => 'baz']), '<input value="baz" type="checkbox" name="foo" id="foo" />', '->render() renders the widget as HTML');
